...
[![Codecov test coverage](https://codecov.io/gh/frankiecho/robust.prioritizr/graph/badge.svg)](https://app.codecov.io/gh/frankiecho/robust.prioritizr)
...
prioritization which extends the `prioritizr` package. It allows users to
