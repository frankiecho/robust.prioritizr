...
```{r, fig.alt = "Map of Victoria, Australia, showing current protected areas."}
pa_categorical <- pa
...
```{r, fig.alt = "Maps of Victoria, Australia, showing projected habitat for the brush-tailed rock-wallaby in 1990, 2030, and 2090."}
...
```{r, fig.alt = "Map of Victoria, Australia, showing the robust conservation planning solution with a 1% target."}
rt <- 0.0022
...
```{r, fig.alt = "Line plots showing the representation of each species across different climate scenarios and time-steps, with a horizontal line indicating the target."}
...
```{r, fig.alt = "Side-by-side maps of Victoria, Australia, comparing the robust (1% target) and partially robust (7% target) conservation planning solutions."}
rt2 <- 0.07
...
```{r, fig.alt = "Line plots showing the representation of each species in the partially robust solution, with a dashed horizontal line indicating the target."}
...
```{r, fig.alt = "Three maps of Victoria, Australia, comparing the robust (1% target), partially robust (7% target), and fully robust* (7% target) conservation planning solutions."}
...
```{r, fig.alt = "Side-by-side maps of Victoria, Australia, comparing the non-robust (7% target) and partially robust (7% target) conservation planning solutions."}
...
```{r, fig.alt = "Line plots comparing the representation of the Orange-bellied parrot for non-robust, partially robust, and fully robust* solutions across different climate scenarios and time-steps."}
