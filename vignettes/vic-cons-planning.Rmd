...
Likewise, we can repeat the calculation to use the CVaR constraints. This ensures that the average of the "tail" of the distribution of feature representation always exceeds our targets.
```{r}
...
We can evaluate whether the new protected areas actually meet the targets by checking whether the Conditional Value-at-Risk metric exceeds the targets.
```{r}
...
In my testing, the CVaR constraint is able to find a solution at a fraction of the time given the same number of features.
```{r}
