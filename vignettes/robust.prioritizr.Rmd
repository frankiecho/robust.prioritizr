---
title: "Motivations for a robust approach to systematic conservation planning"
output:
...
By design, `prioritizr` would prioritize planning units that have a higher number of `feature_1` in the planning unit over other planning units with less of `feature_1`. As shown below, `prioritizr` selects the planning units with the highest estimated number of features.
...
p2 <- problem(sim_pu_raster, sim_features_robust_raster) %>%
  add_robust_constraints(feature_groupings = feature_groupings, probability = 0.95) %>%
  add_absolute_targets(target) %>%
...
Observe that while `prioritizr` sees `feature_1` as being achieved at `r expected_target`, indicated in the green line, the actual representation as simulated from the distribution is nowhere near the expected level. This implies that the shortfall metric used in the standard `prioritizr` is an under-representation of the shortfall target.
...
For its current version, `robust.prioritizr` accommodates two ways uncertainty information, which we refer to in the following ways:

+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                                            | Realization uncertainty                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Range uncertainty                                                                                                                                                                                                                                         |
+============================================+==============================================================================================================================================================================================================================================================================================================================================================================================================================================================================+===========================================================================================================================================================================================================================================================+
| Description                                | Uncertainty is specified in terms of a list of plausible realizations of the world. These realizations are assumed to affect all planning units at once, such that, if "Realization 1" is "true", then planning units 1,...,N take the value as described in "Realization 1". Realizations are assumed to be discrete, such that either "Realization 1" or "Realization 2" (or another realization) is "true", and values in between realizations are considered impossible. | Uncertainty is defined over a numerical range, within which every value in the range is considered "possible" and every value outside the range is considered "impossible". For example, + or - 10% of a planning unit feature, or + or - \$1000 of cost. |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Typical usage                              | -   Climate model and emissions pathway projections of species ranges (e.g., Representative Concentration Pathways)                                                                                                                                                                                                                                                                                                                                                          | -   Measurement error intervals                                                                                                                                                                                                                           |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
|                                            | -   Shared socioeconomic pathways (SSP) projections, or SSP-RCP scenarios                                                                                                                                                                                                                                                                                                                                                                                                    | -   Sensitivity analysis of parameters                                                                                                                                                                                                                    |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
|                                            | -   Outputs of Monte Carlo simulation                                                                                                                                                                                                                                                                                                                                                                                                                                        | -   Data-limited uncertainties                                                                                                                                                                                                                            |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
|                                            | -   Replicates generated from a stochastic model or a process                                                                                                                                                                                                                                                                                                                                                                                                                | -   Problems that are difficult to scale using realization uncertainty approaches                                                                                                                                                                         |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | -   Problems involving uncertainty in conservation costs (as not yet implemented for realization uncertainty)                                                                                                                                             |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Complexity                                 | Increases with respect to:                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Increases with respect to:                                                                                                                                                                                                                                |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
|                                            | -   Number of planning units                                                                                                                                                                                                                                                                                                                                                                                                                                                 | -   Number of planning units                                                                                                                                                                                                                              |
|                                            |                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                                                                                                                                                                                                                                                           |
...
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Linear Programming Formulation             | Minimax                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Robust uncertainty set (only polyhedral budgeted uncertainty sets implemented right now)                                                                                                                                                                  |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| Ability to control the level of robustness | No, though robustness can be altered implicitly by removing realizations from the data                                                                                                                                                                                                                                                                                                                                                                                       | Yes, controlled through a numeric parameter                                                                                                                                                                                                               |
+--------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+

The treatment of realization uncertainty is already covered in the above vignette, but will be given a full treatment in the vignette "Realization Uncertainty" with a simulated example consisting of species projection under different climate change scenarios.

The specification of range uncertainty will be given in the vignette "Range Uncertainty".
...
Also note that objective function specifications in `robust.prioritizr` often increases the number of constraints present in a prioritization problem. Therefore, it would increase the computational requirements of the solution. Translating `prioritizr` problems to `robust.prioritizr` is unlikely to help improve the computational efficiency of the problem or rectify issues with the problem formulation itself.
